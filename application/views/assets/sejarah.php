        ...
        <div class="section-body">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <form action="main/setsejarah" id="save" method="post" enctype="multipart/form-data">
                        <div class="table-responsive">
                            <table class='table'>
                                <tr>
                                    <td>Deskripsi sejarah gitar</td>
                                    <td>
										<textarea rows="10" name="sejarah"  class="" cols="10" style=" min-width:500px; max-width:100%;min-height:50px;height:100%;width:100%;"><?php echo $sejarah->sejarah ?></textarea>
                                    </td>
                                </tr>
								<tr>
									<td></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center> <img id="blah" class='img img-fluid mb-3' width='280'
                                                src="image/<?php echo $sejarah->gambar ?>" alt="your image" />
                                        </center>
