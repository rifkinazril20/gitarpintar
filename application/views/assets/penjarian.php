<?php
$penjarian = $this->db->get('penjarian')->row();
        ...
        <div class="section-body">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <form action="main/setpenjarian" id="save" method="post" enctype="multipart/form-data">
                        <div class="table-responsive">
                            <table class='table'>
                                <tr>
                                    <td>Deskripsi penjarian gitar</td>
                                    <td>
										<textarea rows="10" name="penjarian"  class="" cols="10" style=" min-width:500px; max-width:100%;min-height:50px;height:100%;width:100%;"><?php echo $penjarian->desc ?></textarea>
                                    </td>
                                </tr>
								<tr>
									<td></td>
