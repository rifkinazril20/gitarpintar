<?php
$penjarian = $this->db->get('tangga_nada')->row();
        ...
        <div class="section-body">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <form action="main/settangganada" id="save" method="post" enctype="multipart/form-data">
                        <div class="table-responsive">
                            <table class='table'>
                                <tr>
                                    <td>Deskripsi Tangga Nada gitar</td>
                                    <td>
